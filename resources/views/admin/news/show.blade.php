...
<div class="container mt-5">
  <form action="{{route('news.update',['news'=>$product->id])}}" method="post" enctype="multipart/form-data">
    @csrf
    @method('put')
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Title</label>
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Name Of Product" readonly name="title" value="{{$ost->title}}">
      </div>
      <div>
