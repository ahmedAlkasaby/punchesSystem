...
class TrashBucketPolicy
{
     ...
     */
    public function update(User $user, TrashBucket $trashBucket): bool
    {
     ...
     */
    public function delete(User $user, TrashBucket $trashBucket): bool
    {
     ...
     */
    public function forceDelete(User $user, TrashBucket $trashBucket): bool
    {
     ...
     */
    public function replicate(User $user, TrashBucket $trashBucket): bool
    {
